...
contract MultiSigWallet {
    ...
    modifier txExists(uint _txId) {
        require(transactions.length > _txId, "Transaction id did not exist");
        _;
    }
    ...
    function _getApprovalCount(
        uint _txId
    ) private view returns (uint count /*saves gas*/) {
    ...
    function revoke(
        ...
        require(approved[_txId][msg.sender], "tx not supported");
